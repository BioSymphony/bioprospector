# Future Complex Campaign References

These are workflow families to prep for, not full example campaigns.

## Taxane Oxidative-Route Resolver

Stress test for disputed intermediates, P450 order, hidden transformations, and
host-expression burden.

## Post-Branch MIA Expansion
...
## Cryptic Microbial BGC Dereplication
...
## Triterpene Analog Factory

Stress test for CYP, UGT, BAHD, and transporter family sweeps around scaffold
diversification and host-fit risk.
