...
The agent should call `python3 scripts/bioprospector_doctor.py`
...
review dossier, and Linear-ready issue graph under .runtime/. Keep this planning
pass local and do not write raw sequences, credentials, provider identifiers,
...
repository. Keep large and private artifacts outside Git. Tracked outputs may
contain public accessions, placeholders, checksums, and reviewed summaries.
```
...
## What agents must do first

Run local checks before generating provider plans:
